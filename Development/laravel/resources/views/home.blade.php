...
<style>
    ...
    body.light .hero-section {
        background: linear-gradient(to bottom, rgba(255,255,255,0.8), rgba(240,240,240,0.95)),
                    url('https://image.tmdb.org/t/p/original/6UH52Fmau8RPsMAbQbjwN3wJSCj.jpg') center/cover no-repeat;
...
<div class="flex justify-end px-6">
    <button onclick="toggleTheme()"
        class="p-3 bg-black/40 backdrop-blur-md rounded-full border border-white/20 hover:bg-white/20 transition">
        <svg id="themeIcon" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none"
...
<script>
    ...
    // Override toggleTheme supaya ikon ikut berubah
